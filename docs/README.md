...
| Doc | What's inside |
|-----|---------------|
| [Configuration](configuration.md) | First-time setup, WiFi, Twilio/Discord/custom-HTTP credentials, two-point sensor calibration, emergency thresholds, MQTT broker setup |
...
| [API Reference](api-reference.md) | All 38 ConfigServer REST endpoints with request/response schemas and curl examples |
